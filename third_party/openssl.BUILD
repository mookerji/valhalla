# This BUILD file is built off the example from (https://github.com/qzmfranklin/openssl/tree/bazel).
...
# These settings are typically auto-generated during the
# OpenSSL build process; this allows some of the version
# output to work correctly.
#
# Note that the -DDATE is present to make the build
# more reproducible, see the crypto/cversion.c source for
# more info.
openssl_copts = openssl_copts + [
    '-DCFLAGS=\'\"' + " ".join(openssl_copts) + '\"\'',
    '-DCC=\'\"cc\"\'',
...
cc_library(
    ...
    copts=openssl_copts + ["-Iexternal/openssl"],
